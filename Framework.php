...
class NanoFramework
{
    ...
    function __construct()
    {
        ...
        try{
            ...
            if(isset($_SERVER['HTTP_AUTHORITY'])){
                $_GET['access_token']=$_SERVER['HTTP_AUTHORITY'];
            }
    ...
    public function run($url = null)
    {
        ...
        if ($url == null) {
             ...
             */
            $url = isset($_SERVER['REQUEST_URI'])?$_SERVER['REQUEST_URI']:(isset($_SERVER['PATH_INFO']) ? $_SERVER['PATH_INFO'] : (isset($_SERVER['ORIG_PATH_INFO']) ? $_SERVER['ORIG_PATH_INFO'] :""));

            if (substr($url, 0, strlen($_SERVER['SCRIPT_NAME'])) === $_SERVER['SCRIPT_NAME']) {
            ...
            if ($url == ""||substr($_SERVER['SCRIPT_NAME'], 0, strlen($url)) === $url) {
                $url = "/";
            }
        }
